...
class Booking
{
    ...
    /**
     * Callback appellé à chaque fois qu'on fait une reservation
     * @ORM\PrePersist()
     *
     * @return void
     */
    ...
    public function isBookalbleDates()
    {
        // Il faut connaître les dates qui sont impossible pour l'annonce
     ...
     *
     * @return array Un tableua d'objets DateTime représentant les jours de la reservation
     */
    ...
    {
        $diff = $this->getEndDate()->diff($this->startDate);
        return $diff->days;
    }
