...
class Ad
{
     ...
     * @Assert\Length(
     *     min="10",
     *     minMessage="Le titre ne peut pas faire moins de 10 caractères !",
     *     max="255",
     ...
     * @Assert\Length(
     *     min="20",
     *     minMessage="Votre introduction doit faire au moins 20 caractères !",
     * )
     */
    ...
    /**
     * Permet d'avoir la note moyenne des commentaires
     *
     * @return float
     */
    public function getAvgRating()
    {
        // Calculer la somme des locations
